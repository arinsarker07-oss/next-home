...
export default function OwnerDashboardMain() {
    ...
    const recentBookings = [
        {
            id: "BK-9081",
            property: "Rose Valley Apartment",
        ...
        {
            id: "BK-4412",
            property: "Skyline Studio Penthouse",
    ...
    const favoriteItems = [
        {
            ...
            image: "https://images.unsplash.com/photo-1580587771525-78b9dba3b914?w=150&q=80",
            rent: "৳5,000/day"
        },
        {
            id: "FAV-105",
            property: "Green Valley Cabin",
            location: "Sreemangal",
            image: "https://images.unsplash.com/photo-1510798831971-661eb04b3739?w=150&q=80",
            rent: "৳3,500/day"
        }
    ];
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="bg-white border border-slate-200/60 rounded-2xl p-6 flex items-center justify-between shadow-sm">
                            <div className="space-y-1">
                                ...
                                <p className="text-3xl font-black text-slate-900">{stats.savedProperties}</p>
                            </div>
                            ...
                            <tbody>
                                {recentBookings.map((item) => (
                                    <tr key={item.id} className="border-b border-slate-100 last:border-0 hover:bg-slate-50/50 transition-all">
                                        ...
                                        <td className="p-4 text-sm font-semibold text-slate-600">{item.date}</td>
                                        <td className="p-4 text-sm font-bold text-slate-800">{item.rent.split('/')[0]}</td>
                                        <td className="p-4">
